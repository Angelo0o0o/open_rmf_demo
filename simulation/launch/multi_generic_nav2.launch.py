...
def generate_launch_description():
    ...
    robots = [
        {'name': 'g1', 'x_pose': '0.0', 'y_pose': '0.0', 'z_pose': 0.01, 
           "color_name" : "Green", "color_rgb" : "0 1 0 1"},
        {'name': 'g2', 'x_pose': '0.0', 'y_pose': '1.0', 'z_pose': 0.01,
    ...
    def_dir = get_package_share_directory('simulation')
    ...
    urdf = os.path.join(def_dir,'description','robot.urdf.xacro')
