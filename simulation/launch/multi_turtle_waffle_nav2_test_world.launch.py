...
def generate_launch_description():
    ...
    robots = [
        {'name': 'waffle_1', 'model':'waffle', 'x_pose': '0.0', 'y_pose': '0.0', 'z_pose': 0.01},
        {'name': 'waffle_2', 'model':'waffle','x_pose': '-15.3', 'y_pose': '5.19', 'z_pose': 0.01},
        # {'name': 'waffle_3', 'x_pose': '0.0', 'y_pose': '1.0', 'z_pose': 0.01},
        # {'name': 'waffle_4', 'x_pose': '0.0', 'y_pose': '1.5', 'z_pose': 0.01},
        # ...
        # ...
        ]
    ...
    robots = LaunchConfiguration(
        'robots', 
        default=[{'name': 'waffle_1', 'model':'waffle', 'x_pose': '0.0', 'y_pose': '0.0', 'z_pose': 0.01}],
        )

    declare_robots = DeclareLaunchArgument(
        name='robots', 
        default_value=robots,
        description='List of robots for the map'
        )
    ...
    map_server=Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('simulation'), 'maps', 'test_map.yaml'),
                     },],
