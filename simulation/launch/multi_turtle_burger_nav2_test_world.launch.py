...
def generate_launch_description():
    ...
    robots = [
        {'name': 'burger_1', 'x_pose': '-14.2', 'y_pose': '-5.52', 'z_pose': 0.01},
        {'name': 'burger_2', 'x_pose': '-14.2', 'y_pose': '-3.52', 'z_pose': 0.01},
        # {'name': 'burger_3', 'x_pose': '-4.0', 'y_pose': '3.0', 'z_pose': 0.01},
        # {'name': 'burger_4', 'x_pose': '-4.0', 'y_pose': '4.0', 'z_pose': 0.01},
        # ...
        # ...
        ]
