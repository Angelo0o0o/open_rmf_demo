...
def generate_launch_description():
    ...
    robots = [
        {'name': 'husky_1', 'x_pose': '-3.0', 'y_pose': '3.0', 'z_pose': 0.01},
        {'name': 'husky_2', 'x_pose': '-3.0', 'y_pose': '4.0', 'z_pose': 0.01},
        # ...
        # ...
        ]
    ...
    urdf = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("simulation"), "models", "husky", "urdf", "husky.urdf.xacro"]
            ),
        ]
    )
    ...
    for robot in robots:
        ...
        spawn_turtlebot3_burger = Node(
            ...
            arguments=[
                '-file', os.path.join(simulation, 'models', 'husky', 'model.sdf'),
                '-entity', robot['name'],
