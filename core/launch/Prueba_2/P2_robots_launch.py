...
def generate_launch_description():
    ...
    map_server=Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('simulation'), 'maps', 'Prueba_2.yaml'),
                     },],
