...
def generate_launch_description():
    ...
    robots = [
        {'name': 'tb_1', 'model':'burger','x_pose': '-1.7', 'y_pose': '-10.15', 'z_pose': 0.01},
        # {'name': 'tb_2', 'model':'burger','x_pose': '0.8', 'y_pose': '-10.15', 'z_pose': 0.01},
        # {'name': 'tb_3', 'model':'burger','x_pose': '3.3', 'y_pose': '-10.15', 'z_pose': 0.01},
        {'name': 'tw1', 'model':'waffle', 'x_pose': '-10.7', 'y_pose': '0.1', 'z_pose': 0.01},
        # {'name': 'tw2', 'model':'waffle','x_pose': '7.55', 'y_pose': '0.1', 'z_pose': 0.01}
        ]
    ...
    map_server=Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('simulation'), 'maps', 'Prueba_1.yaml'),
                     },],
